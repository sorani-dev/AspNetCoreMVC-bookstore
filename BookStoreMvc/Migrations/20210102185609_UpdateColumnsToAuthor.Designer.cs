...
namespace BookStoreMvc.Migrations
{
    ...
    [Migration("20210102185609_UpdateColumnsToAuthor")]
    partial class UpdateColumnsToAuthor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreMvc.Data.BookGenre", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStoreMvc.Data.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("BookStoreMvc.Data.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookStoreMvc.Data.BookCategory", b =>
                {
                    ...
                    b.HasOne("BookStoreMvc.Data.Category", "Category")
                        .WithMany("BookCategories")
            ...
            modelBuilder.Entity("BookStoreMvc.Data.BookGenre", b =>
                {
                    ...
                    b.HasOne("BookStoreMvc.Data.Genre", "Genre")
                        .WithMany("BookGenres")
